(() => {
    ...
    (() => {
        ...
        window.addEventListener("scroll", (function() {
            if (window.innerWidth > 767) if (window.scrollY >= 60) headerWrapper.style.cssText = "background-color: #050e26;"; else headerWrapper.style.cssText = "background-color: none;"; else if (window.scrollY >= 40) headerWrapper.style.cssText = "background-color: #050e26;"; else headerWrapper.style.cssText = "background-color: none;";
        }));
        const tabsTitle1 = document.querySelector(".service-tabs__title_1");
        const spollersElement1 = document.querySelector(".spollers__element_1");
        const clickEvent1 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement1.addEventListener("click", (() => {
            tabsTitle1.dispatchEvent(clickEvent1);
        }));
        const tabsTitle2 = document.querySelector(".service-tabs__title_2");
        const spollersElement2 = document.querySelector(".spollers__element_2");
        const clickEvent2 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement2.addEventListener("click", (() => {
            tabsTitle2.dispatchEvent(clickEvent2);
        }));
        const tabsTitle3 = document.querySelector(".service-tabs__title_3");
        const spollersElement3 = document.querySelector(".spollers__element_3");
        const clickEvent3 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement3.addEventListener("click", (() => {
            tabsTitle3.dispatchEvent(clickEvent3);
        }));
        const tabsTitle4 = document.querySelector(".service-tabs__title_4");
        const spollersElement4 = document.querySelector(".spollers__element_4");
        const clickEvent4 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement4.addEventListener("click", (() => {
            tabsTitle4.dispatchEvent(clickEvent4);
        }));
        const tabsTitle5 = document.querySelector(".service-tabs__title_5");
        const spollersElement5 = document.querySelector(".spollers__element_5");
        const clickEvent5 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement5.addEventListener("click", (() => {
            tabsTitle5.dispatchEvent(clickEvent5);
        }));
        const tabsTitle6 = document.querySelector(".service-tabs__title_6");
        const spollersElement6 = document.querySelector(".spollers__element_6");
        const clickEvent6 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement6.addEventListener("click", (() => {
            tabsTitle6.dispatchEvent(clickEvent6);
        }));
        const tabsTitle7 = document.querySelector(".service-tabs__title_7");
        const spollersElement7 = document.querySelector(".spollers__element_7");
        const clickEvent7 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement7.addEventListener("click", (() => {
            tabsTitle7.dispatchEvent(clickEvent7);
        }));
        const tabsTitle8 = document.querySelector(".service-tabs__title_8");
        const spollersElement8 = document.querySelector(".spollers__element_8");
        const clickEvent8 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement8.addEventListener("click", (() => {
            tabsTitle8.dispatchEvent(clickEvent8);
        }));
        const tabsTitle9 = document.querySelector(".service-tabs__title_9");
        const spollersElement9 = document.querySelector(".spollers__element_9");
        const clickEvent9 = new MouseEvent("click", {
            bubbles: true
        });
        spollersElement9.addEventListener("click", (() => {
            tabsTitle9.dispatchEvent(clickEvent9);
        }));
        window["FLS"] = true;
        isWebp();
        addLoadedClass();
